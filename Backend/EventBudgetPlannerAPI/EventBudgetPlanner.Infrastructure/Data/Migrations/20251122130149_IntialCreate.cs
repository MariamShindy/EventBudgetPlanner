    ...
    public partial class IntialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventCategoryBudgets", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_EventTemplate_DefaultBudget", "DefaultBudget >= 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EventTemplateId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventTemplateCategories", x => x.Id);
                    table.CheckConstraint("CK_EventTemplateCategory_EstimatedAmount", "EstimatedAmount >= 0");
                    table.ForeignKey(
                        name: "FK_EventTemplateCategories_EventTemplates_EventTemplateId",
                        column: x => x.EventTemplateId,
                        principalTable: "EventTemplates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Expense_BaseAmount", "BaseAmount >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventCategoryBudgets_EventId_Category",
                table: "EventCategoryBudgets",
                columns: new[] { "EventId", "Category" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Events_CurrencyCode",
                table: "Events",
                column: "CurrencyCode");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventTemplateCategories_EventTemplateId",
                table: "EventTemplateCategories",
                column: "EventTemplateId");

            migrationBuilder.CreateIndex(
                name: "IX_EventTemplateCategories_EventTemplateId_SortOrder",
                table: "EventTemplateCategories",
                columns: new[] { "EventTemplateId", "SortOrder" });

            migrationBuilder.CreateIndex(
                name: "IX_EventTemplates_Category",
                table: "EventTemplates",
                column: "Category");

            migrationBuilder.CreateIndex(
                name: "IX_EventTemplates_CreatedBy",
                table: "EventTemplates",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_EventTemplates_IsPublic",
                table: "EventTemplates",
                column: "IsPublic");
